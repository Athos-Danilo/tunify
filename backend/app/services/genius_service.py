...
class GeniusService:
    ...
    # 🚨 MODIFICADO: Agora a função recebe um 'client' já aberto do httpx
    async def buscar_foto_artista(self, client: httpx.AsyncClient, nome_artista: str) -> str:
        """
        ...
        # 🚨 REMOVIDO: Tiramos o 'async with httpx.AsyncClient() as client:' daqui de dentro
        try:
